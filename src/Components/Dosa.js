...
const Dosa = () => {
  ...
  return (
    <div className="w-screen h-screen fixed">
      <div className={`flex flex-row items-center justify-between p-5 w-full bg-[#FAFAFA] ${
          isOpen ? "fixed" : ""
        }`}>
        <div className="flex space-x-2 text-3xl xl:text-4xl">
          ...
          <div className="web-view-only">
            ...
            {showModal ? (
              <>
                <div className="fixed top-0 left-0 w-full h-full mainmodal items-center flex overflow-x-hidden
                 overflow-y-auto inset-0 z-50 outline-none focus:outline-none">
          ...
          <div class=" dropdown inline-block relative">
            ...
            <ul class="dropdown-menu w-56 px-2 absolute bg-[#fafafa] hidden text-black">
              ...
              <li class="flex align-middle items-center justify-start p-1">
                ...
                <h1 className="text-[14px] ml-2 ">Sat & Sun Closed</h1>
              </li>
            </ul>
          </div>
          <div class=" dropdown inline-block relative">
              ...
              >
                <div className="grad p-2 place-items-center justify-center align-middle text-center self-center rounded-lg">
                  ...
                  <div className="flex p-6 justify-around">
                    <div className="flex bg-slate-100 shadow-orange-500 rounded-xl
                     shadow-md max-w-[360px] w-20 h-20 sm:max-w-none p-1.5 sm:w-16 sm:h-16">
                      <img src="play.png" alt="pic" className="p-1"></img>
                    </div>
                    <div className="flex  bg-slate-100 shadow-orange-500 rounded-xl
                     shadow-md w-20 h-20 max-w-[360px] p-1.5 sm:max-w-none sm:w-16 sm:h-16">
